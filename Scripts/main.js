...
nova.commands.register("kaleidoscope.compareFiles", (workspace) => {
  console.log("Comparing files with Kaleidoscope");
  var cmd = nova.config.get("kaleidoscope.toolcommand", "string");
...
nova.commands.register("kaleidoscope.setFileA", (workspace) => {
...
nova.commands.register("kaleidoscope.setFileB", (workspace) => {
  var te = nova.workspace.activeTextEditor;
...
nova.commands.register("kaleidoscope.clearAllFiles", (workspace) => {
